...
public class Ajiokids
{
	public static void main(String[] args) throws Throwable 
	{
		...
		String productPrice=driver.findElement(By.xpath("//div[text()='"+productName+"'][text()='Logo Print Running Cap']/parent::div[@class='contentHolder']/descendant::span[@class='price  ']")).getText();
